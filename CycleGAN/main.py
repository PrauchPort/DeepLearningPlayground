...
#     r'C:\Users\Wojtek\Documents\Projects\DeepLearningPlayground\CycleGAN\horse2zebra.zip',
...
PATH = os.path.join(
    r'C:\Users\Wojtek\Documents\Projects\DeepLearningPlayground\CycleGAN', 'horse2zebra')
...
train_datasetA = tf.data.Dataset.list_files(PATH + '\\trainA\\*.jpg', shuffle=False)
...
train_datasetB = tf.data.Dataset.list_files(PATH + '\\trainB\\*.jpg', shuffle=False)
...
def generate_images(A, B, B2A, A2B, epoch):
    ...
    for i in range(4):
        ...
        plt.axis('off')
    plt.savefig(
        'C:\\Users\\Wojtek\\Documents\\Projects\\DeepLearningPlayground\\CycleGAN\\images\\generated_%d.png' % epoch)
    plt.close()
