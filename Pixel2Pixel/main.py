...
#     r'C:\Users\Wojtek\Documents\Projects\DeepLearningPlayground\Pixel2Pixel\facades.tar.gz',
#     cache_subdir=os.path.abspath('.'),
#     origin='https://people.eecs.berkeley.edu/~tinghuiz/projects/pix2pix/datasets/facades.tar.gz',
#     extract=True)

PATH = r'C:\Users\Wojtek\Documents\Projects\DeepLearningPlayground\Pixel2Pixel\facades'
...
def generate_images(model, test_input, tar, epoch):
    ...
    for i in range(3):
        ...
        plt.axis('off')
    plt.savefig(
        r'C:\Users\Wojtek\Documents\Projects\DeepLearningPlayground\Pixel2Pixel\images\epoch%d.png' % epoch)
    print('saved images.')
    # plt.show()
